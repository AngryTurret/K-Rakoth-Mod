...
function launchFist()
  ...
  world.spawnProjectile("atprk_computerbosscryoblast", vec2.add(entity.position(), offset), entity.id(), config.getParameter("fistVector", {0,1}), false, {power = self.power, timeToLive = ttl})
